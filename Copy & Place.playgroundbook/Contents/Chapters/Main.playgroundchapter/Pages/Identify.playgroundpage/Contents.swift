/*:
 Now that you've taken the picture it will be sent to the iPad, and using machine learning the iPad will try to figure out what it is.
 
 It may take a few seconds to process the picture. Once it is done, you will see the image as well as the top choices that it found.
 
 Choose one, and then press the "**Next Page**" button below the picture. If there are no choices available, go back and take another picture.
 
 ![Demo Identify](demo-Identify.png)
 *The image above shows what you need to do.*
